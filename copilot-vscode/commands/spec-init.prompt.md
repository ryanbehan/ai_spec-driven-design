---
name: "spec-init"
description: "Initialize a new spec interactively in phased manner with approvals"
agent: agent
---
You are initializing a spec for GitHub Copilot. Follow spec-driven-development.instructions.md rules. Prompt user: "Enter feature name: [input]". Use as {feature_name}, create /spec/{feature_name}/.
