---
applyTo: "**/*"
description: "Spec-driven development guidelines for consistent code generation and project management"
---

# GitHub Copilot Custom Instructions - Spec-Driven Development

## Purpose
This custom instructions file ensures all GitHub Copilot interactions in VS Code adhere strictly to project specifications in /spec/{feature_name}/. Reference specs in every response. Apply these rules in all workflows and development phases.
...
- Use inline suggestions for code completion following spec requirements
- Leverage chat for complex multi-step tasks with spec references
- Use coding agent for autonomous task execution when available
- Reference this file in chat prompts when needed for context
- Apply path-specific instructions for different file types when configured

This file steers all GitHub Copilot interactions toward iterative, spec-driven development.