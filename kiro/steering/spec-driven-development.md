...
## Purpose
This steering file ensures all Kiro interactions adhere strictly to project specifications in /spec/{feature_name}/. Reference specs in every response. Apply these rules in all workflows and development phases.
...
- Leverage autopilot mode for autonomous execution of complex multi-step tasks
- Configure agent hooks to trigger automated actions (unit tests, documentation, optimization)
- Use multimodal chat capabilities for UI design and architecture discussions
- Take advantage of native MCP support for external integrations
- Apply steering rules consistently across IDE and CLI interfaces
- Use spec-driven development as the primary workflow methodology
- Configure project-specific rules in .kiro/steering.md for optimal performance
- Leverage advanced context management for large codebases

This file steers all Kiro interactions toward iterative, spec-driven development.