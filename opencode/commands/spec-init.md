# OpenCode Command: spec-init

## Description
Initializes a new spec interactively in phased manner with approvals using OpenCode terminal interface.

## Usage
Use this prompt in OpenCode to initialize a new spec-driven project.

## Prompt Template
```
You are initializing a spec for OpenCode. Follow #enforce-spec.md rules. Prompt user: "Enter feature name: [input]". Use as {feature_name}, create /spec/{feature_name}/.
...
- Leverage multi-session support for parallel spec development
...
- Use session sharing links for collaboration on spec development